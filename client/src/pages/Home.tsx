...
type Reward = { name: string; required: number; icon: React.ReactNode; accent: string; imagePosition: string };
const rewards: Reward[] = [
  { name: "Official Nexora T-Shirt", required: 25, icon: <Shirt size={24} />, accent: "rose", imagePosition: "0% 41%" },
  { name: "Samsung Tablet", required: 50, icon: <Tablet size={24} />, accent: "plum", imagePosition: "50% 41%" },
  { name: "Branded HP Laptop", required: 100, icon: <Laptop size={24} />, accent: "gold", imagePosition: "100% 41%" },
  { name: "Electric Scooter", required: 250, icon: <CarFront size={24} />, accent: "rose", imagePosition: "0% 72%" },
  { name: "Latest iPhone", required: 500, icon: <CreditCard size={24} />, accent: "plum", imagePosition: "50% 72%" },
  { name: "Royal Enfield 350 CC", required: 750, icon: <CarFront size={24} />, accent: "gold", imagePosition: "100% 72%" },
  { name: "District Partner SUV Car", required: 1000, icon: <CarFront size={24} />, accent: "gold", imagePosition: "50% 88%" },
];
